"""Regression checks for the rivet-move-tactic-stack casebook."""
...
from casebook.harness import assert_expected, rivet_move_tactic_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_move_tactic_stack_summary(), assert_expected())
