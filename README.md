...
rivet-move-tactic-stack is a Elixir project for chess and game engines. It focuses on this technical goal: Build an Elixir toolkit that studies tactic behavior through framed sample traffic, with bounds and ordering tests and explicit failure cases.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 172, risk penalty 5, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
